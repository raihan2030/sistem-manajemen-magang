    ...
    <div class="min-h-screen flex bg-white">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-between p-8 md:p-16 lg:p-20 xl:px-28 relative z-20">
            <div>
                ...
                <!-- Heading -->
                <h1 class="text-3xl md:text-4xl font-extrabold text-[#1f2937] mb-2 tracking-tight">Selamat Datang</h1>
                <p class="text-sm text-gray-500 mb-8 font-medium leading-relaxed">
                    Silakan masuk menggunakan kredensial Anda untuk melanjutkan ke sistem.
                </p>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between pt-2 pb-2">
                        <div class="flex items-center group">
                            ...
                            <label for="remember_me" class="ml-2.5 block text-xs font-semibold text-gray-600 cursor-pointer group-hover:text-gray-900 transition">
                                Ingat Saya
                            </label>
                        </div>
                        @if (Route::has('password.request'))
                            <div class="text-xs">
                                <a href="{{ route('password.request') }}"
                                    class="font-bold text-[#00236F] hover:text-blue-800 transition">
                                    Lupa password?
                                </a>
                            </div>
                        @endif
                    ...
                    <!-- Tombol Submit Login -->
                    <button type="submit"
                        class="w-full bg-[#00236F] text-white py-3.5 rounded-xl text-sm font-bold hover:bg-blue-900 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 flex justify-center items-center shadow-md cursor-pointer">
                        Masuk
                ...
                <div class="relative my-8">
                    ...
                    <div class="relative flex justify-center text-[10px] uppercase font-bold tracking-widest text-gray-400">
                        <span class="bg-white px-4">Atau masuk dengan</span>
                    </div>
                </div>
                ...
                <div class="mt-8 text-center text-sm font-medium text-gray-500">
                    Belum memiliki akun? <a href="{{ route('register') }}"
                        class="font-extrabold text-[#00236F] hover:text-blue-800 hover:underline transition">Daftar Sekarang</a>
                </div>
            </div>
        ...
        <div class="hidden lg:flex lg:w-1/2 relative bg-[#00174A] items-center justify-center overflow-hidden">
            ...
            <div class="relative z-20 flex flex-col items-center justify-center px-12 text-center w-full max-w-lg">
                ...
                <p class="text-sm xl:text-base text-blue-50/90 leading-relaxed font-medium drop-shadow">
                    Wadah terpadu untuk memfasilitasi siswa dan mahasiswa dalam mengembangkan kompetensi dan potensi diri melalui program magang yang terstruktur di lingkungan pemerintahan.
                </p>
            </div>
        </div>
    </div>
