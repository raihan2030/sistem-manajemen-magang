    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center p-8 md:p-16 lg:p-20 xl:px-28 bg-white">
        <div class="w-full max-w-md mx-auto lg:mx-0">
            ...
            <p class="text-sm text-[#1f2937]/70 mb-8 leading-relaxed">
                Ini adalah area aman dari aplikasi. Harap konfirmasi kata sandi Anda sebelum melanjutkan ke halaman berikutnya.
            </p>
            ...
            <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <button type="button" onclick="togglePassword('password', 'eye-icon')" class="absolute inset-y-0 right-0 pr-4 flex items-center cursor-pointer text-gray-400 hover:text-[#00236F] transition-colors">
