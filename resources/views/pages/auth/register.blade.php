    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-between p-8 md:p-16 lg:p-20 xl:px-28 bg-white">
        <div>
            ...
            <form action="#" method="POST" class="space-y-6">
                ...
                <!-- Input Nama -->
                <div>
                    <label class="block text-sm font-semibold text-[#1f2937] mb-2">Nama</label>
                    <div class="relative">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <!-- Ikon Mata (Hide/Show Password Dummy) -->
                ...
                <!-- Tombol Submit -->
                <button type="submit" class="w-full bg-[#00236F] text-white py-3 rounded-lg text-sm font-semibold hover:bg-opacity-90 transition flex justify-center items-center shadow-sm mt-4">
                    Daftar 
            ...
            <div class="mt-6 text-center text-sm text-[#1f2937]/70">
                Sudah memiliki akun? <a href="{{ route('login') }}" class="font-bold text-[#00236F] hover:underline transition">Masuk Sekarang</a>
            </div>
        </div>
