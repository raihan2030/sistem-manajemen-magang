...
@section('content')
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden flex flex-col">
        ...
        <div class="p-5 border-b border-gray-200 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div>
                <h2 class="text-lg font-bold text-[#1f2937]">Permohonan Magang Terbaru</h2>
                <p class="text-xs text-[#1f2937]/60 mt-0.5">7 pengajuan magang paling baru masuk ke sistem</p>
            </div>

            <!-- Kanan: Filter Bulan & Tahun -->
        ...
        <!-- Table Footer: Tampilkan Lebih Banyak -->
        <div class="flex justify-center items-center p-5 border-t border-gray-200 bg-gray-50/50 rounded-b-xl">
            <a href="{{ route('superadmin.permohonan', request()->only(['bulan', 'tahun'])) }}"
                class="text-xs font-bold text-[#00236F] border border-[#00236F]/30 bg-white hover:bg-blue-50 px-5 py-2.5 rounded-lg transition flex items-center gap-1.5">
